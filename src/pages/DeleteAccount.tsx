...
const DeleteAccount = () => {
    ...
    const initialFormData = {
        ...
        reasoning: [
            {
                label: 'I believe that it is no longer necessary for Molo to hold the personal data it holds about me.(Please provide us with detals as to your reasoning below.)',
                value: false,
            },
            {
                label: `Molo is processing my personal data on the basis of my consent, and l wish to withdraw my consent and there are no other grounds under which Molo
can process the personal data.`,
                value: false
            },
            {
                label: `Molo is processing my personal data on the basis of Molo's lecitimate interest and l obiect to such processing. (Please provide us with detai as to your
reasoning below so that we can assess whether there is an overriding interest for us to retain such personal data.)`,
                value: false
            },
            {
                label: `l believe the personal data Molo holds about me is being unlawfully processed by Molo.(Please provide us with detail as to your reasoning below.`,
                value: false
            }
        ]
    }
    ...
    const handleReasoningChange = (index: number) => {
        setFormData(prev => ({
            ...prev,
            reasoning: prev.reasoning.map((item, i) => i === index ? { ...item, value: !item.value } : item) as { label: string; value: boolean }[]
        }) as { country: string; name: string; mobileNumber: string; email: string; accountType: string; accountId: string; rightExercising: string; reasoning: { label: string; value: boolean }[] })
    } 
